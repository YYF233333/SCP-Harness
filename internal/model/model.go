...
type TestResult struct {
	ArtifactID, Outcome, Stdout, Stderr string
	ExitCode                            *int
	Created                             string
}
type Review struct {
...
type Slot struct {
	State string  `json:"state"`
	Owner *string `json:"owner_attempt_id"`
}
type State struct {
...
func NewState() *State {
	return &State{Tasks: map[string]*Task{}, RepositoryIdentities: map[string]string{}, Options: map[string]*Option{}, Claims: map[string]*Claim{}, Artifacts: map[string]*Artifact{}, Attempts: map[string]*Attempt{}, Accounts: map[string]*Account{}, Leases: map[string]*Lease{}, Exploration: map[string]*Exploration{}, Pending: map[string]*Step{}, Tests: map[string]*TestResult{}, Reviews: map[string]*Review{}, Interrupts: map[string]bool{}, Cancellations: map[string]bool{}, RoundRobin: []string{}, Edges: []Edge{}, Events: []Event{}, Blockers: map[string]*Blocker{}, Journals: map[string]*Journal{}, Slot: Slot{State: "IDLE"}}
}
