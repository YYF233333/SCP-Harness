...
try {
    ...
    $cases = [ordered]@{
        ...
        Observation = @('TestLiveAttemptObservation', 'TestObservationInterruptedLogs', 'TestObservationTimedOutLogs', 'TestObservationReadonlyRejection', 'TestObservationConcurrentCapture', 'TestObservationContinuationBase', 'TestObservationCLIGolden', 'TestObservationDirectorySymlinkPivot')
